(function() {
  ...
  const Y = {
    ...
    free_more: "$1 more, locked",
    free_more_d: "You are seeing the first three. Unlock the rest — one payment, forever.",
    free_back: "Back to the list",
    free_bar: "Free version · first $1 of each list",
    free_have_key: "I have a key",
    boot_ready: "Ghoosted is starting…",
    boot_lost: "Lost your key?",
    share_bar: "$1 left this week",
    share_btn: "Share",
    share_line: "$1 people unfollowed me this week",
    share_line_1: "One person unfollowed me this week",
    share_line_f: "$1 people unfollowed me this week",
    share_foot: "Found out with",
    share_saved: "Saved to your downloads",
    share_failed: "Could not create the image",
    boot_done: "Activated. Reloading…",
    ...
    dos_ghost_note: "Ghost mode · designed to stay out of “seen by”",
    ...
    gh_note: "These people have a story up right now. Open it from here: designed not to register the view or put you in their viewer list. Depends on how Instagram works.",
    gh_watch_note: "Ghost mode — designed not to register as seen. Depends on Instagram.",
    gh_refresh: "Refresh",
